          ...
          >
            {messages.map((msg, idx) => (
              ...
              >
                <div
                  style={{
                    backgroundColor: msg.sender === 'bot' ? '#103FE5' : '#E5E7EB',
                    color: msg.sender === 'bot' ? 'white' : '#374151',
                    padding: '12px 16px',
      ...
      {!isOpen && (
        <div
          ...
          style={{
            ...
            alignItems: 'center',
            gap: '8px',
            boxShadow: '0 4px 20px rgba(16, 63, 229, 0.3)',
        ...
        >
          <span className="toggle-text">Questions?</span>
          <svg className='toggle-icon' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="status-dot1" style={{
            width: '8px',
            height: '8px',
            backgroundColor: '#27BE5A',
            borderRadius: '50%',
            position: 'absolute',
            top: 3,
            left: 3,
          }}></div>
          <div className="status-dot2" style={{
            width: '8px',
            height: '8px',
            backgroundColor: '#27BE5A',
            borderRadius: '50%',

        ...
        ">
          ...
          ">
            ...
            <div class="message assistant">
              ...
              color: #444;
            ">
              By engaging in this conversation with the Moby AI chatbot, you agree<br>to our <a href="https://moby.host/terms" target="_blank" style="color: black; text-decoration: underline;">Terms and Conditions</a>.
            </div>
            </div>
          </div>
      ...
      if (input) {
        ...
        if (isMobileDevice()) {
          ...
          input.addEventListener('touchstart', function (e) {
            ...
            // Scroll input into view after a short delay to let focus settle
            setTimeout(() => {
              if (document.activeElement === input) {
                scrollInputIntoView();
              }
            ...
            // Also scroll after keyboard appears (if it wasn't already visible)
            setTimeout(() => {
              if (document.activeElement === input) {
                scrollInputIntoView();
              }
